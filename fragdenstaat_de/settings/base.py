...
class FragDenStaatBase(German, Base):
    ...
    CMS_TEMPLATES = [
        ...
        ("cmssites/cmssite/ubf_reduced.html", "Ubf Reduced"),
    ]
    EMAIL_BODY_PLUGINS = [
        "IsDonorPlugin",
        "IsNotDonorPlugin",
        ...
        config.update(
            {
                ...
                "content_urls": {
                    ...
                    "help_request_what": "/hilfe/TODO/",
                    "help_request_what_not": "/hilfe/TODO/",
                    "help_request_public": "/hilfe/TODO/",
                    "help_request_privacy": "/hilfe/TODO/",
                },
