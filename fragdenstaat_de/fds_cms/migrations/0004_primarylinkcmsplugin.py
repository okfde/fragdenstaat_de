...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='fds_cms_primarylinkcmsplugin', serialize=False, to='cms.CMSPlugin')),
                ...
                ('anchor', models.CharField(blank=True, help_text='Page anchor.', max_length=128, verbose_name='anchor')),
