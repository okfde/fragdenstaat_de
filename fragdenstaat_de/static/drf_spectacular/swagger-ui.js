...
const csrfHeaderName = document.currentScript.getAttribute('data-csrfheadername');
const csrfToken = document.currentScript.getAttribute('data-csrftoken');
const schemaUrl = document.currentScript.getAttribute('data-schemaurl');
